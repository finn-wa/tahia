...
/**
 * Creates the formatter's result TextEdit by scanning through the tokens and comparing them with
 * the original source.
 */
public class ExperimentalTextEditsBuilder extends TokenTraverser {
    ...
    private ExperimentalTextEditsBuilder childBuilder;
    private final ExperimentalTextEditsBuilder parent;
    ...
    private ExperimentalTextEditsBuilder(ExperimentalTextEditsBuilder parent) {
    ...
    public static void appendIndentationString(
    ...
    private void flushBuffer(int currentPosition) {
        ...
        while (!sourceMatch && this.currentRegion < this.regions.size()) {
            ...
            if (
                this.currentRegion == this.regions.size() - 1 ||
    ...
    private void handleStructuredToken(Token comment, int index) {
        ...
        if (this.childBuilder == null) {
            this.childBuilder = new ExperimentalTextEditsBuilder(this);
        }
